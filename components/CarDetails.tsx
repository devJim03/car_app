'use client' //bc we used headless ui
...
interface CarDetailsProps{
    isOpen:boolean;
    closeModal:()=>void;
    car:CarProps; //this is pretty cool, reusing another interface the carProps interface
}
    ...
    <>
        <Transition appear show={isOpen} as={Fragment}>
            <Dialog as ='div' className='relative z-10' onClose={closeModal}>
                {/*this effect darkens the page as sort of like a background*/}
                            ...
                            <Dialog.Panel className='relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl bg-white p-6 text-left shadow-xl transition-all flex flex-col gap-5'>
                                ...
                                <div className='flex-1 flex flex-col gap-2'>
                                    ...
                                    <div className='mt-3 flex flex-wrap gap-4'>
                                        {/*not only do we need the values of the car object we also need the keys aka the labels like city_mpg, class...etc*/}
                                        {/*object.entries returns an array filled with both the keys and the value we map over that array and using array destructuring we can get both the value and the key*/}
